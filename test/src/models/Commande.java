...
public class Commande extends Panier{
    ...
    public Commande(int qt_panier, int id, String reference, String nom, String image, double prix, int quantite) {
        super(qt_panier, id, reference, nom, image, prix, quantite);
    }
