...
public class AccueilPartenaireController implements Initializable {
    ...
    @FXML
    private void ClubLoad(MouseEvent event) {
        loadUI("GestionClub");
    }

    @FXML
    private void CompetitionLoad(MouseEvent event) {
        loadUI("GestionCom");
    }

    @FXML
    private void AnnonceLoad(MouseEvent event) {
        loadUI("GestionAnnonce");
    }

    @FXML
    private void PubliciterLoad(MouseEvent event) {
        loadUI("GestionPub");
    }

    @FXML
    public void ReclamationLoad(MouseEvent event) {
        loadUI("affichereclamation");
    }

    @FXML
    private void CategorieRecLoad(MouseEvent event) {
        loadUI("GestionCategorieRec");
    }

    @FXML
    private void loadLivraison(MouseEvent event) {
        loadUI("GestionLivraison");

    }

    @FXML
    private void loadCommande(MouseEvent event) {
        loadUI("GestionCommande");

    }

    @FXML
    private void loadPaiement(MouseEvent event) {
