...
public class ModifierCategorieController implements Initializable {
    ...
    private void ModifierCategorie(ActionEvent event) {
        ...
        else if (nom_categorie.getText().length() < 3){
             errors_nom.setTextFill(Color.TOMATO);
             errors_nom.setText("Le nom doit contenir au moins 3 caractere");

        }
         else if (description_categorie.getText().length() < 6){
             errors_description.setTextFill(Color.TOMATO);
             errors_description.setText("La description doit contenir au moins 6 caractere");
           
        }
         else if (!nom_categorie.getText().matches("[a-zA-Z]*")){
              errors_nom.setTextFill(Color.TOMATO);
              errors_nom.setText("Nom invalide");   
        } 
